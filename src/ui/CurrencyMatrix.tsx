      ...
      <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0">
        <table className="w-full text-left text-xs border-collapse">
          ...
          <tbody className="divide-y divide-neutral-800/60 font-mono">
            {currencies.map(c => {
              const marketVal = c.marketStrength;
              const fundVal = c.fundamentalState.fundamentalScore;
                ...
                >
                  ...
                  <td className="py-2.5 px-2 tabular-nums">
                    {marketVal !== null ? (
                      ...
                      >
                        {marketVal >= 0 ? '+' : ''}{marketVal.toFixed(2)}
                      </span>
                    ) : (
                  ...
                  <td className="py-2.5 px-2">
                    ...
                    <span className="text-neutral-500 text-[10px] ml-1">
                      ({c.centralBank.currentPolicyRate !== null ? `${c.centralBank.currentPolicyRate}%` : 'N/A'})
                    </span>
                  </td>
